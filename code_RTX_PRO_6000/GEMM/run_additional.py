...
def load_implementations():
    """Load all available GEMM implementations."""
...
def run_fp16_gemm():
    ...
    # For FP16, only cuBLAS and CuTile are guaranteed to handle dtype correctly.
    # Triton kernel hardcodes bfloat16 output cast; WMMA/Raw SIMT are BF16 CUDA kernels.
    from gemm_cublas import gemm_cublas
    from gemm_cutile import HAS_CUTILE
    cutile_fn = None
    if HAS_CUTILE:
